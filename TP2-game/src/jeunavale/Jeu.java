...
public class Jeu {
	...
	public void demarre() {
		...
		if (joueur1.aPerdu()) {
			...
			else System.out.println(joueur2.nom+ " a gagne !");
		} else System.out.println(joueur1.nom + " a gagne !");
	}
